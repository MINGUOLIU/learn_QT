...
{
    ui->setupUi(this);
    QObject::connect(ui->radioButton_black,SIGNAL(clicked(bool)),this,SLOT(do_FontColor()));
    QObject::connect(ui->radioButton_blue,SIGNAL(clicked(bool)),this,SLOT(do_FontColor()));
    QObject::connect(ui->radioButton_red,SIGNAL(clicked(bool)),this,SLOT(do_FontColor()));
}
